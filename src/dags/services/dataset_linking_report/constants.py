...
DAG_PARAMS = {
    ...
    "th": Param(None, type=["number", "null"], minimum=0.0, maximum=100.0, description="Pair similarity threshold, percentage 0..100"),
    "keyword_method": Param(None, type=["null", "string"], enum=[None, "jaccard", "sbert"], description="jaccard or sbert"),
    ...
    "graphs_only_above_threshold": Param(None, type=["null", "boolean"], description="Generate graphs only for pairs passing th"),
