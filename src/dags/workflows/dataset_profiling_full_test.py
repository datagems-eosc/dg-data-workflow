...
from dags.common.enum.connector_type import DataStoreKind
from dags.common.extensions.callbacks import on_execute_callback, on_failure_callback, on_retry_callback, on_skipped_callback, on_success_callback, on_success_profiling_callback
...
def dataset_profiling():
    ...
    @task.sensor(on_execute_callback=on_execute_callback, on_retry_callback=on_retry_callback,
          on_success_callback=on_success_callback, on_failure_callback=on_failure_callback,
          on_skipped_callback=on_skipped_callback, poke_interval=WAIT_FOR_COMPLETION_POKE_INTERVAL, mode="reschedule",
