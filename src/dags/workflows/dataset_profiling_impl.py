...
from services.profiler_auth import ProfilerAuthService
...
def dataset_profiling():
    ...
    def create_profile():
        ...
        trigger_profile_url, trigger_profile_headers, trigger_profile_payload = config_profiling(access_token, dag_context)
