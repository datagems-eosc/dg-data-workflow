...
class DatasetPackagingConfig:
    class DatasetPackagingCoreConfig:
    ...
    def __init__(self):
        ...
        self.options = self.DatasetPackagingCoreConfig(Variable.get("dataset_packaging", deserialize_json=True))
